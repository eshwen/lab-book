\newpage
\section{Interesting thoughts and interpretations of dark matter (29/09/2016)}
...
& At the LHC, monojets are used most prominently to look for dark matter particles. But multijet plus $E_{\mathrm{T}}^{\mathrm{miss}}$ might provide better sensitivity and constraints (particularly if the mediator is pseudoscalar).

& The Coma Cluster of galaxies seems to contain a very high concentration of dark matter (mass-to-light ratio of 400 $M_{\astrosun} / L_{\astrosun}$). See \cite{Yozin:2015mla}.
