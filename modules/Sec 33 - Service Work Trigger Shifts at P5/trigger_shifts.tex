...
\begin{easylist}
\easylistprops
& Online trigger workbook: \sloppy\url{https://twiki.cern.ch/twiki/bin/viewauth/CMS/OnlineWBTrigger}
...
& Lumi monitoring: \sloppy\url{https://op-webtools.web.cern.ch/vistar/vistars.php?usr=LHC1}
...
I'll also have to attend extra meetings, which can be found at \sloppy\url{https://twiki.cern.ch/twiki/bin/view/CMS/CaloLayer2OnCall#Meetings_to_attend_while_on_call} and in my Evernote note.
