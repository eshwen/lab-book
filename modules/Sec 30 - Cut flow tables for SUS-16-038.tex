...
\subsection{Tables for the remaining benchmark models}
...
\begin{tabular}{lcccc}
  ...
  \hline
   ...
   $H_{\mathrm{T}}^{\mathrm{miss}} > 200\,\mathrm{GeV}$  & \phantom{1}84\phantom{.1} & \phantom{1}37\phantom{.1} & \phantom{1}83\phantom{.1} & \phantom{1}27\phantom{.1} \\
  ...
  $H_{\mathrm{T}}^{\mathrm{miss}} / E_{\mathrm{T}}^{\mathrm{miss}} < 1.25$ & \phantom{1}75\phantom{.1} & \phantom{1}31\phantom{.1} & \phantom{1}72\phantom{.1} & \phantom{1}23\phantom{.1} \\
  $H_{\mathrm{T}}$-dependent $\alpha_{\mathrm{T}}$ requirements ($H_{\mathrm{T}} < 900\,\mathrm{GeV}$)  &  \phantom{1}75\phantom{.1} & \phantom{1}25\phantom{.1} & \phantom{1}72\phantom{.1} & \phantom{1}17\phantom{.1} \\
...
\begin{tabular}{lcccc}
  ...
  \hline
   ...
   $H_{\mathrm{T}}^{\mathrm{miss}} > 200\,\mathrm{GeV}$  & \phantom{1}50\phantom{.1} & \phantom{1}16\phantom{.1} & \phantom{10}2.4 & \phantom{1}36\phantom{.1} \\
  Event veto for forward jets ($|\eta| > 2.4$) & \phantom{1}43\phantom{.1} & \phantom{1}14\phantom{.1} & \phantom{10}2.0 & \phantom{1}31\phantom{.1} \\
  $H_{\mathrm{T}}^{\mathrm{miss}} / E_{\mathrm{T}}^{\mathrm{miss}} < 1.25$ & \phantom{1}42\phantom{.1} & \phantom{1}12\phantom{.1} & \phantom{10}1.6 & \phantom{1}30\phantom{.1} \\
  $H_{\mathrm{T}}$-dependent $\alpha_{\mathrm{T}}$ requirements ($H_{\mathrm{T}} < 900\,\mathrm{GeV}$)  &  \phantom{1}40\phantom{.1} & \phantom{10}9.9 & \phantom{10}0.8 & \phantom{1}18\phantom{.1} \\
