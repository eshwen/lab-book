...
I wrote a short talk giving an update on the cut flows using Tai's method. The link to the slides is %\href{run:sec18/Cut flow tables progress II.pdf}{Cut flow tables progress II}.
